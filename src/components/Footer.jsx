      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-gray-900 mb-3">NUTRIJECT</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-4 max-w-md">
              Aplikasi tracking nutrisi berbasis AI yang membantu Anda mencapai gaya hidup sehat dengan mudah dan menyenangkan.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-orange-500 flex items-center justify-center text-white hover:shadow transition-transform duration-150">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#benefits" className="text-gray-600 hover:text-orange-500 transition-colors">Benefits</a></li>
              <li><a href="/setting" className="text-gray-600 hover:text-orange-500 transition-colors">Settings</a></li>
            </ul>
          </div>
        ...
        <div className="pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600 text-center md:text-left">
              &copy; {new Date().getFullYear()} <span className="font-semibold text-gray-900">AllIn4Data</span>. All rights reserved.
            </p>
