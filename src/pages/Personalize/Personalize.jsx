          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="py-auto">
                ...
                <div className="text-main text-gray-500 flex items-center gap-2">
                  <FaCalendarDay className="text-gray-400" />{' '}
                  <span>{tanggal || 'Belum ada laporan'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2 bg-orange-500 text-white rounded-md shadow"
              >
                Start Eating
              </button>
              <button
              ...
              <button
                onClick={onLogout}
                className="px-3 py-2 bg-red-50 text-red-600 rounded-md flex items-center gap-2"
              >
                <FaSignOutAlt /> Logout
              </button>
            </div>
            ...
            {hasReport && userData ? (
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="mt-3 text-sm text-gray-600 space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium">
                          {userData.TDEE ? Math.round(userData.TDEE) : '-'}
                        </span>
                      </div>
                    </div>
                    <div className="mt-4 flex gap-2">
                  ...
                  <div className="bg-white rounded-lg p-3 shadow-sm">
                    ...
                    <ul className="mt-2 text-sm text-gray-700 list-disc list-inside space-y-1">
                      ...
                      <li>
                        Batasi gula olahan untuk kontrol energi jangka panjang.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="border border-dashed border-gray-200 rounded-lg p-6 text-center">
                <h3 className="text-lg font-semibold mb-2">
                  Belum ada laporan kebutuhan gizi
                </h3>
                <p className="text-sm text-gray-600 mb-4">
                  Kamu belum memiliki laporan kebutuhan gizi harian. Ayo mulai
                  dengan menghitung kebutuhan gizimu dengan kalkulator gizi
                  kami.
                </p>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div
            role="dialog"
            aria-modal="true"
            className="relative bg-white rounded-lg shadow-lg max-w-3xl w-full mx-4 p-6 max-h-[90vh] overflow-auto"
          >
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-lg font-semibold">Tambahkan Makanan</h3>
                <p className="text-sm text-gray-500">
                  Pilih metode untuk menambahkan makanan ke laporan hari ini.
                </p>
              </div>
              <button
                onClick={() => setShowModal(false)}
                className="text-gray-400 hover:text-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-300 p-2"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      Pindai label nutrisi dari foto kemasan.
                    </div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      Ambil foto makanan untuk deteksi otomatis.
                    </div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      Masukkan data gizi secara manual.
                    </div>
                  </div>
                </div>
              </button>
