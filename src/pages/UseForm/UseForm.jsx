...
import { FaBirthdayCake, FaVenusMars, FaRulerVertical, FaWeight, FaRunning } from 'react-icons/fa';
      ...
      <main className="max-w-4xl mx-auto py-8 px-4">
        <div className="bg-white shadow rounded-lg p-6 md:p-8">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-gray-500">Isi data untuk mendapatkan rekomendasi nutrisi harian</p>
          </div>

          {successMessage && (
            <div className="mt-4 p-3 bg-green-50 border border-green-100 text-green-800 rounded">{successMessage}</div>
          )}

          <form onSubmit={handleSubmit} className="mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700">Umur (tahun)</label>
                <div className="relative mt-1">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                    <FaBirthdayCake className="w-5 h-5" />
                  </div>
                  <input inputMode="numeric" type="number" name="age" value={formData.age} onChange={handleChange} min="0" required className="mt-0 block w-full border border-gray-200 rounded-md px-3 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-orange-200" placeholder="e.g. 30" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <select name="gender" value={formData.gender} onChange={handleChange} required className="mt-0 block w-full border border-gray-200 rounded-md px-3 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-orange-200">
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input inputMode="numeric" type="number" name="height" value={formData.height} onChange={handleChange} min="0" required className="mt-0 block w-full border border-gray-200 rounded-md px-3 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-orange-200" placeholder="e.g. 170" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input inputMode="numeric" type="number" name="weight" value={formData.weight} onChange={handleChange} min="0" required className="mt-0 block w-full border border-gray-200 rounded-md px-3 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-orange-200" placeholder="e.g. 65" />
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative mt-1">
                  ...
                  <select name="activity" value={formData.activity} onChange={handleChange} required className="mt-0 block w-full border border-gray-200 rounded-md px-3 py-3 pl-10 focus:outline-none focus:ring-2 focus:ring-orange-200">
                    <option value="">Pilih</option>
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center sm:items-center gap-3">
              <button type="submit" disabled={loading} className="w-full sm:w-auto inline-flex justify-center items-center px-5 py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 focus:outline-none disabled:opacity-60">
                {loading ? (
              ...
              <button type="button" onClick={() => { setFormData({ age: '', gender: '', height: '', weight: '', activity: '' }); setResults(null); setDiagrams({ kalori:0, karbohidrat:0, protein:0, lemak:0, gula:0, garam:0, air:0 }); setSuccessMessage(''); }} className="w-full sm:w-auto px-4 py-3 border rounded-lg text-sm">Reset</button>
            </div>
          </form>
