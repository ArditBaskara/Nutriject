  ...
  const healthTips = [
    {
      icon: <FaLeaf />,
      title: 'Balanced Diet',
      text: 'Mix vegetables, proteins, and carbs for optimal health',
    },
    {
      icon: <FaHeart />,
      title: 'Heart Health',
      text: 'Track sodium and saturated fats to protect your heart',
    },
    {
      icon: <FaSmile />,
      title: 'Feel Great',
      text: 'Proper nutrition boosts energy and mood',
    },
  ];
    ...
    <div className="bg-gradient-to-br from-orange-50 via-white to-green-50 min-h-screen">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div
            className="absolute inset-0 hero-slide s1"
            style={{ backgroundImage: "url('/hero/1.jpg')" }}
          />
          <div
            className="absolute inset-0 hero-slide s2"
            style={{ backgroundImage: "url('/hero/2.jpg')" }}
          />
          <div
            className="absolute inset-0 hero-slide s3"
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-2xl md:text-3xl font-semibold text-gray-700 mb-4 hero-subtitle">
          ...
          {user ? (
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-2xl mx-auto mb-8">
              <p className="text-xl text-gray-700 mb-6">
                Welcome back,{' '}
                <span className="font-bold text-nutriGreen">
                  {user.name || 'User'}
                </span>
                !
              </p>
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                A web-based AI application that detects nutrition in processed
                and packaged food —{' '}
                <span className="font-semibold text-nutriGreen">
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-nutriGreen/10 to-nutriOrange/10">
        <div className="max-w-4xl mx-auto text-center">
          <blockquote className="text-2xl md:text-3xl font-medium text-gray-700 italic">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 transform transition-all duration-500">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                <div
                  className={`inline-block p-4 rounded-2xl bg-gradient-to-br ${features[activeFeature].color} text-white`}
                >
                ...
                <p className="text-xl text-nutriOrange font-semibold">
              ...
              <div className="grid grid-cols-2 gap-4">
                {features[activeFeature].images.map((img, idx) => (
                  <img
                    ...
                    src={img}
                    alt={`Feature ${idx + 1}`}
                    className="rounded-xl shadow-lg hover:scale-105 transition-transform duration-300 w-full h-48 object-cover"
                  />
                ))}
              </div>
            </div>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`inline-block p-3 rounded-xl bg-gradient-to-br ${feature.color} text-white mb-4`}
                >
                  {feature.icon}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Real people, real results — small changes make big differences.
            </p>
          </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    "I swap snacks for fruit — I feel lighter!"
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-200">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    "Portion control + veggies = energy all day."
                  </div>
                </div>
              </div>
              <div className="mt-4 flex flex-wrap gap-2">
              ...
              <div className="mt-4">
                <div className="flex justify-between text-sm text-gray-600 mb-2">
                  <span>Calories/day</span>
                  <span className="font-semibold">2,050</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="h-2 rounded-full bg-green-500"
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-200">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    "I meal-prep with colorful veggies — it's easy!"
                  </div>
                </div>
              </div>
              <div className="mt-4 flex flex-wrap gap-2">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-green-50 to-orange-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Small changes lead to big health benefits
            </p>
          </div>
      ...
      {!user && (
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center bg-gradient-to-r from-nutriOrange to-nutriGreen rounded-3xl p-12 md:p-16 shadow-2xl text-white">
            ...
            <button
              onClick={() => navigate('/auth')}
              className="px-12 py-5 bg-white text-nutriOrange text-xl font-bold rounded-2xl hover:bg-gray-50 transform hover:scale-105 transition-all duration-300 shadow-xl"
            >
